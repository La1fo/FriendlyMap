...
DEFINITIONS: List[AchievementDefinition] = [
    ...
    AchievementDefinition("use_20_unique_tags", "Коллекционер тегов", "Используй 20 уникальных тегов в approved локациях", "🏷️", "standard", 20, 40),
    AchievementDefinition("active_10_days", "10 активных дней", "Иметь approved локации в 10 разных днях", "📅", "standard", 10, 50),
    ...
    AchievementDefinition("approved_25_locations", "25 approved", "Получить 25 одобренных локаций", "🥉", "standard", 25, 60),
    AchievementDefinition("approved_50_locations", "50 approved", "Получить 50 одобренных локаций", "🥈", "standard", 50, 90),
    AchievementDefinition("approved_100_locations", "100 approved", "Получить 100 одобренных локаций", "🥇", "standard", 100, 150),
    ...
    AchievementDefinition("season_add_5_locations", "Сезон: 5 локаций", "5 approved локаций за сезон", "🧭", "ranked", 5, 50, 20),
    AchievementDefinition("season_add_3_in_24h", "Сезонный спринт", "3 approved за 24 часа в сезоне", "🚀", "ranked", 3, 45, 15),
    AchievementDefinition("season_top_10", "Топ-10 сезона", "Закончить сезон в топ-10", "🏅", "ranked", 10, 80, 25),
    AchievementDefinition("season_first_3_days", "Ранний старт", "Первая approved в первые 3 дня сезона", "🌅", "ranked", 1, 45, 15),
    ...
    AchievementDefinition("season_add_5_in_2_days", "Марафон 48ч", "5 approved за 48 часов в сезоне", "⏱️", "ranked", 5, 70, 20),
