...
from .faq import faq_menu_handler, faq_menu_button_handler, faq_conversation_handler
from .support import support_handler
from .navigation import main_menu_callback_handler
def get_all_handlers():
    return [
        ...
        faq_menu_handler,
        faq_menu_button_handler,
        faq_conversation_handler,
        support_handler,
